...
[[ $(sha256sum /gta-source/re3 | cut -d ' ' -f 1) == 575fe67064b8250dfbb06645a7046b30677ebbc5515838bda551f4fec37df6b7 ]]
[[ $(sha256sum /gta-source/reVC | cut -d ' ' -f 1) == bf95d1f4ba3f360d92414e52ada07cd653934627fd2eefc06e4f87c024c13fcf ]]
