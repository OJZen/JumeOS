...
readonly EXPECTED_UUID=d3130010-46a4-4d56-9001-000000000010
readonly STAGE=/run/r46h-pair-v0.10
...
readonly RECEIPT=/var/lib/r46h/remote-pair-v0.10
...
receipt_stage=/var/lib/r46h/.remote-pair-v0.10.$$
printf 'feature_id=r46h-remote-pair-v0.10\npublic_key_sha256=%s\npublic_key_fingerprint=%s\nscript_sha256=%s\n' \
