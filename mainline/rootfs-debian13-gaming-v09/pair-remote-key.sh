...
readonly EXPECTED_UUID=d3130009-46a4-4d56-9001-000000000009
readonly STAGE=/run/r46h-pair-v0.9
...
readonly RECEIPT=/var/lib/r46h/remote-pair-v0.9
...
receipt_stage=/var/lib/r46h/.remote-pair-v0.9.$$
printf 'feature_id=r46h-remote-pair-v0.9\npublic_key_sha256=%s\npublic_key_fingerprint=%s\nscript_sha256=%s\n' \
