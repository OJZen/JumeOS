...
private slots:
    ...
    void settingsFocusAndValueEditing() {
        ...
        const auto settingsCategories = settings->property("categories").toList();
        QCOMPARE(settingsCategories.size(), 12); QVERIFY(!settingsCategories.contains(QStringLiteral("蓝牙")));
