...
readonly EXPECTED_UUID=d3130018-46a4-4d56-9001-000000000018
readonly STAGE=/run/r46h-pair-v0.18
...
readonly RECEIPT=/var/lib/r46h/remote-pair-v0.18
...
receipt_stage=/var/lib/r46h/.remote-pair-v0.18.$$
printf 'feature_id=r46h-remote-pair-v0.18\npublic_key_sha256=%s\npublic_key_fingerprint=%s\nscript_sha256=%s\n' \
